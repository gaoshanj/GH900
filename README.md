...
## Course Materials
[Course GH-900 English version](https://learn.microsoft.com/en-us/training/courses/gh-900t00)
[Course GH-900 简体中文版本](https://learn.microsoft.com/zh-cn/training/courses/gh-900t00)
[Course GH-900 正體中文版本](https://learn.microsoft.com/zh-tw/training/courses/gh-900t00)
...
[GH-900 Lab files (SampleApps.zip)](https://raw.githubusercontent.com/MicrosoftLearning/APL-2007-Accelerate-app-development-by-using-GitHub-Copilot/master/LearnModuleExercises/Downloads/SampleApps.zip)
--&gt;
...
[GitHub Codespaces: Everything you need to know](https://www.youtube.com/watch?v=mBsvSFbcujg)
...
- 02. [Exercise - A guided tour of GitHub](https://learn.microsoft.com/en-us/training/modules/introduction-to-github/6-guided-tour-of-github)
- 04. [Exercise - Configure code scanning](https://learn.microsoft.com/en-us/training/modules/configure-code-scanning/5-exercise)
- 05. [Exercise - Develop with AI-powered code suggestions by using GitHub Copilot and VS Code](https://learn.microsoft.com/en-us/training/modules/introduction-to-github-copilot/5-exercise)
- 06. [Exercise - Code with Codespaces and Visual Studio Code](https://learn.microsoft.com/en-us/training/modules/code-with-github-codespaces/5-exercise-code-with-codespaces)
- 08. [Exercise - Communicate using Markdown](https://learn.microsoft.com/en-us/training/modules/communicate-using-markdown/3-communicating-using-markdown)
- 09. [Exercise - Create your first pull request](https://learn.microsoft.com/en-us/training/modules/contribute-open-source/4-exercise-create-pr)
- 10. [Exercise - InnerSource fundamentals](https://learn.microsoft.com/en-us/training/modules/manage-innersource-program-github/3-innersource-fundamentals)
- 11. [Exercise - Secure your repository&#39;s supply chain](https://learn.microsoft.com/en-us/training/modules/maintain-secure-repository-github/3-security-strategy-essentials)
- 14. [Exercise - Reviewing pull requests](https://learn.microsoft.com/en-us/training/modules/manage-changes-pull-requests-github/3-review-pull-requests)
...
[Practice Assessment](https://learn.microsoft.com/en-us/credentials/certifications/github-foundations/practice/assessment?assessment-type=practice&amp;assessmentId=954809103&amp;practice-assessment-type=certification)
[Exam duration and question types](https://learn.microsoft.com/en-us/credentials/support/exam-duration-exam-experience)
[Study Guide](https://learn.microsoft.com/en-us/credentials/certifications/resources/study-guides/gh-900)
